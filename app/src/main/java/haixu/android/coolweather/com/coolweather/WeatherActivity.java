...
public class WeatherActivity extends AppCompatActivity {
    ...
    private TextView titleUptateTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleUptateTime = (TextView) findViewById(R.id.title_update_time);
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=687696a7c842462b9e4b61d8bd0f24a2";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        titleUptateTime.setText(updateTime);
